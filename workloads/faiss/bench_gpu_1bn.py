...
# Generate result filename with timestamp and config
uvm_suffix = "_uvm" if use_uvm else ""
float16_suffix = "_fp16" if use_float16 else ""
timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
result_filename = f"{dbname}_{index_key.replace(',', '_')}{uvm_suffix}{float16_suffix}_{timestamp}.json"
